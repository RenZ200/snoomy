...
CREATE TABLE IF NOT EXISTS google_connections (
 id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, user_name TEXT NOT NULL UNIQUE, tokens TEXT NOT NULL, calendar_id TEXT NOT NULL DEFAULT '', last_synced BIGINT NOT NULL DEFAULT 0
);
CREATE TABLE IF NOT EXISTS google_states (
 id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, state_hash TEXT NOT NULL UNIQUE, browser_hash TEXT NOT NULL, session_hash TEXT NOT NULL, user_name TEXT NOT NULL, verifier TEXT NOT NULL, expires BIGINT NOT NULL
);
CREATE TABLE IF NOT EXISTS google_maps (
 id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, user_name TEXT NOT NULL, kind TEXT NOT NULL CHECK(kind IN ('schedule','task')), local_id INTEGER NOT NULL, event_id TEXT NOT NULL, baseline TEXT NOT NULL, UNIQUE(user_name,kind,local_id), UNIQUE(user_name,event_id)
);
